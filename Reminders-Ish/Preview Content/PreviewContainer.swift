...
struct SampleData {
    ...
    static var reminders: [Reminder] {
        return [Reminder(title: "Reminder 1", notes: "This is a reminder 1 note"), Reminder(title: "Reminder 2", notes: "This is a reminder 2 note", reminderDate: Date(), reminderTime: Date())]
    }
}
